...
/* 
 * -------------------------------------------------------------
 *  HOW TO UPLOAD CUSTOM TRADER IMAGES
 * -------------------------------------------------------------
 * 1. Create a folder named 'traders' inside your 'public' folder.
 * 2. Add your images naming them 1.jpg, 2.jpg ... 20.jpg.
 * 3. Update the 'avatar' field in INITIAL_TRADERS below to:
 *    avatar: '/traders/1.jpg',
 * -------------------------------------------------------------
 */
